...
| 看到的 | 意思 |
|---|---|
| 🏬 一栋楼 | 一个 workspace。**每 3 个工作层插 1 个公共层**(楼够高时),楼层数随 root 会话数增长(只长不轻易缩);砖材/霓虹竖牌/楼顶装置由 id hash 决定 |
